...
export const GET   = compose(withRequestContext, withRateLimit(), withErrorHandling)(handleGetPrintJob)
export const PATCH = compose(withRequestContext, withRateLimit(), withErrorHandling)(handleUpdatePrintJob)
